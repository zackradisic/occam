...
static inline HMM_Quat HMM_QFromAxisAngle_RH(HMM_Vec3 Axis,
...
static inline HMM_Quat HMM_QFromAxisAngle_LH(HMM_Vec3 Axis,
                                             float AngleOfRotation) {
...
#define HMM_Mul(A, B)                                                          \
  _Generic((B), float                                                          \
           ...
           : _Generic((A), HMM_Vec2                                            \
                      ...
                      : HMM_MulV3, HMM_Vec4                                    \
                      : HMM_MulV4, HMM_Mat2                                    \
                      : HMM_MulM2V2, HMM_Mat3                                  \
                      : HMM_MulM3V3, HMM_Mat4                                  \
                      : HMM_MulM4V4))(A, B)
...
#define HMM_LenSqr(A)                                                          \
  _Generic((A), HMM_Vec2                                                       \
           : HMM_LenSqrV2, HMM_Vec3                                            \
           : HMM_LenSqrV3, HMM_Vec4                                            \
           : HMM_LenSqrV4)(A)
...
#define HMM_Transpose(M)                                                       \
  _Generic((M), HMM_Mat2                                                       \
           : HMM_TransposeM2, HMM_Mat3                                         \
           : HMM_TransposeM3, HMM_Mat4                                         \
           : HMM_TransposeM4)(M)

#define HMM_Determinant(M)                                                     \
  _Generic((M), HMM_Mat2                                                       \
           : HMM_DeterminantM2, HMM_Mat3                                       \
           : HMM_DeterminantM3, HMM_Mat4                                       \
           : HMM_DeterminantM4)(M)

#define HMM_InvGeneral(M)                                                      \
  _Generic((M), HMM_Mat2                                                       \
           : HMM_InvGeneralM2, HMM_Mat3                                        \
           : HMM_InvGeneralM3, HMM_Mat4                                        \
           : HMM_InvGeneralM4)(M)
